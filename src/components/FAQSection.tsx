      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1E4E92] text-white text-xs font-bold uppercase tracking-widest mb-4">
            <HelpCircle className="w-4 h-4 text-[#DCEBFF]" />
          ...
          {FAQ_DATA.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-bold text-[#153E75] text-base sm:text-lg font-heading">
                    {item.question[lang]}
                  </span>
                  <div className={`p-2 rounded-full bg-[#F5F7FA] text-[#1E4E92] transition-transform duration-300 ${isOpen ? 'rotate-180 bg-[#1E4E92] text-white' : ''}`}>
